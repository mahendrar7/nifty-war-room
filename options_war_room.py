...
def print_dashboard(df, spot, atm, momentum_strikes, expiry,
    ...
    save_signals(
        ...
        squeeze=squeeze,
        spot_roc1=round(state.spot_history[-1] - state.spot_history[-2], 2) if len(state.spot_history) >= 2 else 0,
        ...
        sniper_dir=sniper_result["direction"] if sniper_result else None,
        sniper_score=sniper_result["score"] if sniper_result else None,
        sniper_setup=sniper_result.get("setup") if sniper_result else None,
        sniper_confidence=sniper_result.get("confidence") if sniper_result else None,
...
def save_signals(spot, atm, gamma, straddle, bias, confidence, regime, action,
                 ...
                 squeeze, spot_roc1, trend_dir, trend_pts, trend_duration,
    ...
    with open(_SIGNALS_CSV, "a", newline="") as f:
        ...
        if not file_exists:
            writer.writerow([
                ...
                "squeeze", "spot_roc1", "trend_dir", "trend_pts", "trend_duration_min",
                "sniper_action", "sniper_dir", "sniper_score", "sniper_setup", "sniper_confidence",
                "trade_strike", "trade_type", "trade_dir",
                "htl_verdict", "htl_score", "htl_source",
                "ml_signal", "ml_confidence", "days_to_expiry",
        ...
        writer.writerow([
            ...
            squeeze or "", spot_roc1, trend_dir or "", trend_pts, trend_duration,
            sniper_action or "", sniper_dir or "", sniper_score or "", sniper_setup or "", sniper_confidence or "",
